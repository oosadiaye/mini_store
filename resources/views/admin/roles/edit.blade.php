...
<div class="container mx-auto px-4 py-6 max-w-3xl">
    ...
    <form action="{{ route('admin.roles.update', $role) }}" method="POST" class="bg-white rounded-lg shadow p-6">
        @csrf
        @method('PUT')
        ...
        <div class="flex justify-end gap-3">
            ...
            <button type="submit" class="bg-indigo-600 text-white px-4 py-2 rounded-md hover:bg-indigo-700">Update Role</button>
        </div>
    </form>
</div>
@endsection
