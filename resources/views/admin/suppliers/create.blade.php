...
<div class="max-w-2xl mx-auto">
    ...
    <form action="{{ route('admin.suppliers.store') }}" method="POST" class="bg-white rounded-lg shadow p-8">
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <textarea name="notes" rows="3"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500">{{ old('notes') }}</textarea>
            </div>
        ...
        <div class="mt-8 flex justify-end space-x-4">
            <a href="{{ route('admin.suppliers.index') }}" class="px-6 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50">
                Cancel
            </a>
