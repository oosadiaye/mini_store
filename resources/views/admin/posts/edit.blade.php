...
<div class="max-w-4xl mx-auto">
    ...
    <form action="{{ route('admin.posts.update', $post->id) }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg shadow p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="excerpt" rows="2"
                    class="w-full px-4 py-2 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500">{{ old('excerpt', $post->excerpt) }}</textarea>
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="content" rows="10"
                    class="w-full px-4 py-2 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500">{{ old('content', $post->content) }}</textarea>
            </div>
        ...
        <div class="mt-8 flex justify-end space-x-4">
            <a href="{{ route('admin.posts.index') }}" class="px-6 py-2 border-2 border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50">
                Cancel
            </a>
